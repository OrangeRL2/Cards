...
await upsertMilestone(
  { level: 7, oshiId: null, awardType: 'card' },
  {
    level: 7,
    oshiId: null,
    awardType: 'card',
    awardValue: { poolFolder: "./assets/images/S", count: 3 },
    oneTime: true,
    enabled: true,
    priority: 5
  }
...
await upsertMilestone(
  { level: 17, oshiId: null, awardType: 'card' },
  {
    level: 17,
    oshiId: null,
    awardType: 'card',
...
await upsertMilestone(
  { level: 27, oshiId: null, awardType: 'card' },
  {
    level: 27,
    oshiId: null,
    awardType: 'card',
...
await upsertMilestone(
  { level: 37, oshiId: null, awardType: 'card' },
  {
    level: 37,
    oshiId: null,
    awardType: 'card',
...
await upsertMilestone(
  { level: 47, oshiId: null, awardType: 'card' },
  {
    level: 47,
    oshiId: null,
    awardType: 'card',
...
await upsertMilestone(
  { level: 57, oshiId: null, awardType: 'card' },
  {
    level: 57,
    oshiId: null,
    awardType: 'card',
...
await upsertMilestone(
  { level: 91, oshiId: null, awardType: 'card' },
  {
    ...
    oshiId: null,
    awardType: 'card',
    awardValue: { poolFolder: "./assets/images", count: 1 }, // BDAY for entire pool
    oneTime: true,
    enabled: true,
    priority: 5
  }
